 ...
 * the methods {@link #pin(simpledb.file.Block) pin} and
 * {@link #pinNew(String, simpledb.buffer.PageFormatter) pinNew}
 ...
 * then a {@link simpledb.buffer.BufferAbortException} is thrown.
...
//      bufferMgr = new $BasicBufferMgr$$(numbuffers);
    ...
    public BufferMgr( IBufferMgr bufferMgr) {
    ...
    * time period, then a {@link simpledb.buffer.BufferAbortException} is thrown.
